...
import backgroundImage from '../UserLayout/wallpaperflare.com_wallpaper.jpg'; // Adjust the path to your background image
import userPhoto from '../UserLayout/OIP (9).jpg'; // Replace with the actual user photo
import movie1 from '../UserLayout/OIP (10).jpg';
import movie2 from '../UserLayout/OIP (7).jpg';
import movie3 from '../UserLayout/OIP (3).jpg';
    ...
    <div className='relative'>
      ...
      <div className='relative bg-black bg-opacity-75 min-h-screen'>
        ...
        <div className='container mx-auto py-12 px-4 md:px-8'>
          <h1 className='text-4xl font-bold mb-6 text-white'>Admin</h1>
          ...
          <div className='mb-8'>
            <div className='flex items-center mb-6'>
              ...
              <div>
                <h2 className='text-2xl font-semibold text-white mb-2'>Senesh</h2>
          ...
          {/* Added Movies */}
          <div className='mb-8'>
            <h2 className='text-2xl font-semibold text-blue-600 mb-4'>Added Films</h2>
            <div className='flex justify-between items-center mb-4'>
              ...
              <Link 
                to='/del'
                className='bg-red-500 text-white py-2 px-4 rounded shadow-md hover:bg-red-800'>
                Delete Film
              </Link>
              </div>
            </div>
            <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4'>
              {bookedMovies.map((movie, index) => (
                <div key={index} className='flex flex-col items-center'>
                  <img src={movie.photo} alt={movie.name} className='w-40 h-48 rounded-lg shadow-md mb-2'/>
